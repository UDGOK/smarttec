...
const faqs = [
  ...
  { q: "What NVIDIA and Cerebras models do you run?", a: "NVIDIA H100, H200, and B200 at launch, with GB200 racks as allocation opens. Cerebras wafer-scale systems for fastest-inference workloads. Multi-vendor evaluation track open for Phase 2/3 — including AMD Instinct MI455X-class (Helios) inference as ROCm serving and OEM availability mature. Bare-metal or orchestrated." },
      ...
      <div className="bg-background">
        ...
        <section className="bg-background">
          <div className="relative mx-auto w-full max-w-[1400px] px-6 md:px-12 lg:px-16 py-20 md:py-28">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              ...
              >
                <div className="relative w-full aspect-[16/9] bg-slate overflow-hidden">
                  <Image src="/hardware/nvidia-hgx-b200-baseboard.jpg" alt="NVIDIA HGX B200 8-GPU baseboard" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
                <div className="p-8 md:p-10">
                  <span className="font-anybody font-extrabold text-2xl text-slate mb-4 block">[ NVIDIA ]</span>
                  <h2 className="text-3xl md:text-4xl font-anybody font-extrabold text-slate mb-4 leading-tight">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-anybody font-extrabold mb-3">
