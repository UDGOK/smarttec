        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="mt-10 border border-dashed border-slate/30 bg-fog/50 p-5 md:p-6">
            ...
            <p className="font-anybody text-slate/70 text-sm leading-relaxed">
              ...
              (CS-3 product page, public marketing assets). The wafer-vs-B200 scale comparison is from the Cerebras WSE-3 announcement. We deploy these exact systems at our Tulsa, OK facility.
            </p>
          </div>
        </div>
      </section>
