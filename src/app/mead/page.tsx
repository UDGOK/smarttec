...
const faq = [
  ...
  { q: "What power does the Mead site have?", a: "A 3 MVA transformer at 208V three-phase, owned and on-site. Phase 1A (8× HGX B200 — 64 GPUs installed, 60 rentable, ~114 kW IT load) uses about 4% of that capacity, leaving more than 20× headroom for expansion across Buildings 2 and 3 plus planned on-site solar (~500 kW) — all without a utility upgrade or interconnection application." },
