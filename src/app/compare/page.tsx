...
const dims = [
  { d: "Scale today", h: "Gigawatt-class, global regions", n: "Multi-GW contracted (CoreWeave/Nebius ~3.5 GW each); much not yet online", m: "Aggregated from hosts, highly variable", s: "114 kW Phase 1A (8× HGX B200 — 64 installed, 60 rentable), Q4 2026 — honest: we are the smallest column on this table", win: false },
  ...
  { d: "Interconnection exposure", h: "Years-long queues for new capacity (~1,500 GW backlog US-wide)", n: "Growth gated on converting contracted power to active power", m: "None directly", s: "Zero queue — Phase 1A uses about 4% of an owned transformer", win: true },
  { d: "Capacity certainty", h: "Shared regions; GPU quotas and waitlists", n: "Priority flows to $B-scale anchor customers", m: "Spot preemption is the business model", s: "Contracted, not oversubscribed — capacity sells by reservation, and we never sell the same GPU twice", win: true },
  ...
  { d: "Track record", h: "Decades", n: "Years, at massive scale", m: "Years, uneven", s: "Pre-launch. Our proof is owned assets and signed infrastructure paper — title, transformer, a 60-month fiber contract — not history. We will not pretend otherwise", win: false },
];
      ...
      <div className="bg-background">
        ...
        <section className="mx-auto w-full max-w-[1400px] px-6 md:px-12 lg:px-16 pt-12">
          <blockquote className="border-l-4 border-greptile-green pl-6 py-2 max-w-3xl">
            <p className="text-xl md:text-2xl font-anybody font-bold text-slate italic leading-snug">&ldquo;We can&apos;t out-scale CoreWeave, so we don&apos;t try. We out-own them: our land, our transformer, our batteries, our contracts. At 64 GPUs, certainty beats size.&rdquo;</p>
        ...
        <section className="mx-auto w-full max-w-[1400px] px-6 md:px-12 lg:px-16 py-14">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border-2 border-greptile-green bg-greptile-green/10 p-6">
              ...
              <p className="text-slate/80 leading-relaxed">You run 1–60 GPUs of steady workload and want a fixed number on the invoice, zero preemption, single-tenant isolation, sub-10ms battery-backed power, and a named engineer who answers. Our whole Phase 1 is built around exactly this customer.</p>
            </div>
