...
const dims = [
  ...
  { d: "Capacity certainty", h: "Shared regions; GPU quotas and waitlists", n: "Priority flows to $B-scale anchor customers", m: "Spot preemption is the business model", s: "Contracted, not oversubscribed — anchor commitments in place before power-on, and we never sell the same GPU twice", win: true },
