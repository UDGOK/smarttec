...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      { type: "faq", items: [
        ...
        { q: "Will SmartTec offer AMD GPUs?", a: "Not in Phase 1A, which is 8× HGX B200 — 64 GPUs installed, 60 rentable — plus Cerebras CS-3 capacity at the Mead, Oklahoma site. SmartTec has opened a multi-vendor evaluation track for Phase 2 that includes MI455X-class inference, gated on OEM availability at small-operator scale, ROCm serving-stack maturity, and measured dollars-per-token versus B200." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "faq", items: [
        ...
        { q: "How does SmartTec cool its B200 cluster?", a: "Phase 1A (8× HGX B200, 64 GPUs installed, ~114 kW IT) uses engineered air cooling — 45 tons installed across three CRAC units with hot/cold-aisle containment — with mechanical space and power reserved to move to direct-to-chip liquid in Phase 2 as densities rise." }
      ] },
      { type: "sources", items: [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "faq", items: [
        ...
        { q: "What PUE does SmartTec target?", a: "Phase 1A at Mead uses engineered air with hot/cold-aisle containment at ~114 kW IT load, with the bigger lever being Oklahoma power at ~$0.08/kWh and behind-the-meter z1power batteries. As-built PUE will be published at power-on rather than promised in advance — measured beats marketed." }
      ] },
      { type: "sources", items: [
