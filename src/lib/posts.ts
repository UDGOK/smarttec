...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      { type: "p", text: "Gas turbines are the obvious answer — they're proven, they're fast to deploy, and they don't need grid interconnection. But they burn fuel continuously, they fail to start under load, and federal customers won't touch them under ITAR." },
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "AURA is our orchestration layer. It does two things: predict grid instability 48 hours before it happens, and shift compute / battery load to keep GPU clusters running uninterrupted." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "ul", items: [
        "ITAR. Federal customers can't deploy grid-independent compute on foreign-made cells. Almost every commercial LFP cell pack contains foreign-made cells or sub-components. We manufacture cells at our Tulsa facility, end-to-end, with full chain-of-custody audit.",
      ...
      { type: "p", text: "Low electricity prices. Low disaster risk (no hurricanes, low seismic activity, away from the tornados). Fast interconnection timelines with the local utility. State-level incentives for energy infrastructure manufacturing. And a friendly policy environment for ITAR-compliant manufacturing." },
    ],
  },
  {
    ...
    readTime: "7 min read",
    body: [
      { type: "p", text: "If you sell to federal customers, ITAR is non-negotiable. The Defense Federal Acquisition Regulation Supplement (DFARS) requires that covered articles be manufactured by US persons and not contain certain foreign-made components. For AI compute, that gets complicated fast." },
      { type: "h2", text: "The silicon question" },
      { type: "p", text: "NVIDIA H100 and H200 chips are fabricated in Taiwan (TSMC). Strictly speaking, that means they're foreign-made. But there's a carveout: the Bureau of Industry and Security (BIS) has issued guidance that US-assembled products containing TSMC-fabricated chips can still qualify as US-origin under certain conditions." },
      { type: "p", text: "We work closely with NVIDIA and our federal customers' general counsels to ensure each deployment meets the applicable ITAR requirements. For most non-classified workloads, this is achievable. For classified workloads, we're pursuing a separate authorization path." },
      { type: "h2", text: "The battery question" },
      { type: "p", text: "BESS cells are where ITAR gets simpler and harder at the same time. Simpler: cells manufactured in the US are clearly US-origin. Harder: very few vendors manufacture LFP cells in the US at the scale we need." },
      { type: "p", text: "We solved this by manufacturing cells at our Tulsa facility. Cell production, module assembly, BMS design — all in-house, all US persons, full chain-of-custody audit available to federal customers." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "SmartTec is now a grid-independent AI cloud. NVIDIA and Cerebras compute on batteries we build. The brand had to say \"modern cloud infrastructure\" while keeping the technical credibility of the hardware story." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "A grid-independent AI cloud. NVIDIA and Cerebras compute running on z1power megawatt battery storage — designed and manufactured by us, end-to-end, in Tulsa, Oklahoma. When the grid drops, the batteries take over in under 10 milliseconds. Your training job keeps running." },
